                ...
                <div class="col-md-6">
                    <p><strong>Gender:</strong> 
                        @if($student->gender == 'male')
                            {{ ucfirst($student->gender) }} <i class="bi bi-gender-male"></i> 
                        @else
                            {{ ucfirst($student->gender) }} <i class="bi bi-gender-female"></i>
                        @endif
                    </p>
    ...
    <div class="card watercolor-card">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <p><strong>Gender:</strong> 
                        @if($student->parent && $student->parent->gender == 'male')
                            {{ ucfirst($student->parent->gender) }} <i class="bi bi-gender-male"></i> 
                        @elseif($student->parent && $student->parent->gender == 'female')
                            {{ ucfirst($student->parent->gender) }} <i class="bi bi-gender-female"></i>
                        @else
                            N/A
                        @endif
                    </p>
                ...
                <div class="col-md-6">
                    <p><strong>Parent Email:</strong> {{ $student->parent->email ?? 'N/A' }}</p>
                    <p><strong>Parent Contact:</strong> {{ $student->parent->phone ?? 'N/A' }}</p>
                </div>
            </div>
        </div>
    </div>
